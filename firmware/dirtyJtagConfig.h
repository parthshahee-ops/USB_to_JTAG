...
// Power and Enable Signals (Keep these default)
#define PIN_PWR       24
#define PIN_EN        25

// Dummy JTAG pins (Keep these so the compiler doesn't throw "undefined" errors)
#define PIN_TCK  26  
#define PIN_TDI  27  
#define PIN_TMS  28  
#define PIN_TDO  29  
...
// UART bridge disabled for pure speed
